...
namespace Unity.FPS.Game
{
    ...
    public class RoleData_SO : ScriptableObject
    {
        ...
        [SerializeField]
        DisplayDic<SpeechTypeEnum, List<NoticeData_SO>> speechs;
        ...
        public NoticeData_SO Speech(SpeechTypeEnum type)
        {
            if (speechs.TryGet(type,out var list))
            {
                if(list.Count>0) return list.RandomTake();
            }
