...
namespace Unity.FPS.Game {
    ...
    public class DamageData
    {
        ...
        [Header("碰撞")]
        [InspectorName("特效使用碰撞点的朝向")]
        public bool UseCollisionDirection = true;
        [InspectorName("特效沿法线偏移量")]
        ...
        [InspectorName("创建弹坑")]
        public bool UseHole;
        [InspectorName("弹坑/不填使用默认")]
        public GameObject Hole;

        [Header("蓄力")]
        [SerializeField]
        [InspectorName("满蓄伤害倍率")]
        private float ChargeDamageScale = 1;
        [SerializeField]
        [InspectorName("满蓄溅射范围倍率")]
        private float ChargeAOERangeScale = 1;

        [InspectorName("满蓄子弹速度")]
        public float ChargeSpeedScale = 1;
        [InspectorName("满蓄子弹重力")]
