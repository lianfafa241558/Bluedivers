...
namespace Unity.FPS.Gameplay
{
    ...
    public class TeleportPlayer : MonoBehaviour
    {
        ...
        void Awake()
        {
            m_PlayerCharacterController = FindObjectOfType<PlayerController>();
            DebugUtility.HandleErrorIfNullFindObject<PlayerController, TeleportPlayer>(
        ...
        void Update()
        {
            if (Input.GetKeyDown(ActivateKey))
            {
                ...
                HealthEnemy playerHealth = m_PlayerCharacterController.GetComponent<HealthEnemy>();
                if (playerHealth)
                {
