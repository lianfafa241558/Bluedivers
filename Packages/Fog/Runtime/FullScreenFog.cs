...
namespace Meryuhi.Rendering
{
    ...
    public enum FullScreenFogMode
    {
        ...
        Height,
        /// <summary>
        /// Combine height fog with distance fog: fog factor = distanceFactor * heightFactor.
        /// Fog only appears in low altitude AND far distance.
        /// </summary>
        HeightAndDistance,
    }
    ...
    public class FullScreenFog : VolumeComponent, IPostProcessComponent
    {
        ...
        internal static bool UseStartLine(FullScreenFogMode mode) => mode == FullScreenFogMode.Depth || mode == FullScreenFogMode.Distance || mode == FullScreenFogMode.HeightAndDistance;
        /// <summary>
        /// Combined mode uses additional height params (_HeightParams) in the shader.
        /// </summary>
        internal static bool UseHeightParams(FullScreenFogMode mode) => mode == FullScreenFogMode.HeightAndDistance;
        /// <summary>
